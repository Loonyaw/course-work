...
// Buttons
const btnLogin = document.querySelector(".login__btn1");
...
btnLogin.addEventListener("click", function (e) {
  ...
  if (bothInputsEmpty) {
    ...
    warningText.textContent = "Пустые имя пользователя и пароль!";
    warningText.classList.add("active");
  } else if (usernameEmpty) {
    inputLoginUsername.classList.add("warning");
    warningText.textContent = "Пустое имя пользователя!";
    warningText.classList.add("active");
  } else if (passwordEmpty) {
    inputLoginPin.classList.add("warning");
    warningText.textContent = "Пустой пароль!";
    warningText.classList.add("active");
